      ...
      <div className="trabajo-container">
        <div className="trabajo-contenido">
          ...
          <div className="trabajo-info-contenedor">
            ...
            {trabajo.año && (
              <div className="trabajo-info-item">
                <span className="año-label" style={{ opacity: 0.8, fontWeight: 300, textTransform: 'none', marginRight: '0.5rem', color: '#222' }}>año</span>
                <span style={{ fontSize: '1.05rem', fontWeight: 700, color: '#111' }}>{trabajo.año}</span>
              </div>
            )}
